  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h2 className="text-5xl font-bold text-gray-900 mb-4">
              Understand your hormonal health in{' '}
              <span className="text-primary-600">3 minutes</span>
            </h2>
            <p className="text-xl text-gray-600 mb-6">
              Private, AI-powered PCOS risk insights
            </p>
            <p className="text-lg text-gray-500 max-w-2xl mx-auto">
              Get personalized risk assessment and lifestyle recommendations based on 
              your symptoms, cycle patterns, and lifestyle factors.
            </p>
          </div>
          ...
          <button
            ...
            className="bg-primary-600 hover:bg-primary-700 text-white font-semibold py-4 px-8 rounded-lg text-lg shadow-lg transition-all duration-200 flex items-center space-x-2 mx-auto"
          >
      ...
      <footer className="container mx-auto px-4 py-8 text-center text-gray-600 text-sm">
        <p>© 2024 OvaSense AI. For informational purposes only.</p>
      </footer>
    </div>
  )
}
